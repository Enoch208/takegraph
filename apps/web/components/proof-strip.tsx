...
function CaseStudy({ proof }: { proof: Result<DemoProof> }) {
  return (
    <section className="group relative min-h-[480px] flex-1 overflow-hidden border border-border lg:flex-[1.6]">
      ...
      />
      {/* Placeholder framing for the ORBIT master, which lands here once the
          baseline build has run and stored real media in B2. It is labelled as
          pending rather than dressed up with stock imagery. */}
      <div className="absolute inset-0 flex flex-col justify-between p-8">
        <div className="flex items-start justify-between">
          <MicroLabel tone="signal">[ Featured Production ]</MicroLabel>
          <span className="border border-review/40 px-2 py-1 font-mono text-[10px] uppercase tracking-widest text-review">
